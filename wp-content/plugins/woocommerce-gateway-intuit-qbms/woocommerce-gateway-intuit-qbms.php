...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '2.2.0', __( 'WooCommerce Intuit QBMS Gateway', 'woocommerce-gateway-intuit-qbms' ), __FILE__, 'init_woocommerce_gateway_intuit_qbms', array( 'is_payment_gateway' => true ) );
...
class WC_Intuit_QBMS extends SV_WC_Payment_Gateway_Plugin {
	...
	public function includes() {
		...
		// gateway classes
		require_once( 'includes/class-wc-gateway-intuit-qbms.php' );
		require_once( 'includes/class-wc-gateway-intuit-qbms-credit-card.php' );
		// require_once( 'includes/class-wc-gateway-intuit-qbms-echeck.php' );  // commented out until/if QBMS really supports echecks

		// token class
		require_once( 'includes/class-wc-intuit-qbms-payment-token.php' );
	}
	...
	public function include_template_functions() {
		...
		require_once( 'includes/wc-gateway-intuit-qbms-template.php' );
	}
	...
	public function get_plugin_name() {
		return __( 'WooCommerce Intuit QBMS Gateway', self::TEXT_DOMAIN );
	}
...
/**
 * The WC_Intuit_QBMS global object
 * @name $wc_intuit_qbms
 * @global WC_Intuit_QBMS $GLOBALS['wc_intuit_qbms']
 */
$GLOBALS['wc_intuit_qbms'] = new WC_Intuit_QBMS();
