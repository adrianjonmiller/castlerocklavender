...
Contributors: wpexperte
Donate link: http://wpexperte.de/wpex-replace
Tags: cleanup, admin, database, rename, replace, url, post, page
...
== Description ==
With [WPEX Replace DB Urls](http://wpexperte.de/wpex-replace "WPEX Replace DB Urls") you can replace one ore more urls in the complete database. Serialized strings are also supported.
...
1. The menu to wpex replace.
2. Instantly scan your database and see which urls are found.
3. List of excluded urls.
